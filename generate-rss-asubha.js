...
const itemsXml = history.map(item => `
    <item>
      ...
      <description><![CDATA[
        ${item.image ? `<img src="${item.image}" alt="Asubha imagery" style="max-width: 100%; height: auto; margin-bottom: 15px;" /><br>` : ''}
        ${item.content}
        <br><br>
...
<rss version="2.0">
  <channel>
    <title>Asubha Practice</title>
    <link>https://loicuaducphat.org/congcu/trichdan</link>
    <description>Asubha Practice</description>
